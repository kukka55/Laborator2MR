...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null)
            Log.println(Log.DEBUG, "activitylifecyclemonit", "onCreate() method was invoked without a previous state");
        else
            Log.println(Log.DEBUG, "activitylifecyclemonit", "onCreate() method was invoked with a previous state");
    ...
    {
        super.onRestart();
        Log.println(Log.DEBUG, "activitylifecyclemonit", "onRestart() method was invoked");
    }
    ...
    {
        super.onStart();
        Log.println(Log.DEBUG, "activitylifecyclemonit", "onStart() method was invoked");
    }
    ...
    {
        super.onResume();
        Log.println(Log.DEBUG, "activitylifecyclemonit", "onResume() method was invoked");
    }
    ...
    {
        super.onPause();
        Log.println(Log.DEBUG, "activitylifecyclemonit", "onPause() method was invoked");
    }
    ...
    {
        super.onStop();
        Log.println(Log.DEBUG, "activitylifecyclemonit", "onStop() method was invoked");
    }
    @Override
    protected void onDestroy()
    {
        super.onDestroy();
        Log.println(Log.DEBUG, "activitylifecyclemonit","onDestroy() method was invoked");
    }
